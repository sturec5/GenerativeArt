 ...
 * @param {} _renderTarget
 */
PatternControler.prototype.applyPattern = function (
  _x,
  _y,
  _w,
  _h,
...
PatternControler.prototype._drawPattern = function () {
  ...
  const func =
    typeof this.patternFunction === "function"
...
PatternVertexInfo.prototype.addBezierVertex = function (
  x2,
  y2,
  x3,
  y3,
...
(function () {
  ...
  p5.prototype.quadPattern = function (...args) {
    ...
    this._patternControler.applyPattern(
      minX,
      minY,
      maxX - minX,
      maxY - minY,
